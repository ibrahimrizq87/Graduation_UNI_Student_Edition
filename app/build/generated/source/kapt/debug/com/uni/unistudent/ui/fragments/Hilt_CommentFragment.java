 ...
 */
public abstract class Hilt_CommentFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CommentFragment() {
    super();
  }

  Hilt_CommentFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CommentFragment_GeneratedInjector) this.generatedComponent()).injectCommentFragment(UnsafeCasts.<CommentFragment>unsafeCast(this));
    }
  }
