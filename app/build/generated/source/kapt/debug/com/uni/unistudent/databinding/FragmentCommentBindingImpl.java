...
public class FragmentCommentBindingImpl extends FragmentCommentBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.progress_bar_comment, 1);
        sViewsWithIds.put(R.id.comment_recycler, 2);
        sViewsWithIds.put(R.id.comment_section, 3);
        sViewsWithIds.put(R.id.comment_ed_text, 4);
        sViewsWithIds.put(R.id.send_comment_bt, 5);
    }
    // views
    @NonNull
